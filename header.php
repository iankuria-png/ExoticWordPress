...
<head>
    ...
    <meta name="viewport"
        content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, target-densityDpi=device-dpi, user-scalable=no">
                    ...
                    <div class="subnav-menu-wrapper r">
                        <ul class="subnav-menu vcenter r">
                            <?php if (!is_user_logged_in() && !get_option("hide31")) { ?>
                                ...
                                <li class="subnav-menu-btn login-btn"><a
                                        href="<?php echo wp_login_url(get_current_url()); ?>"><span
                            ...
                            <?php if (is_user_logged_in()) {
                                ...
                                ?>
                                <li class="subnav-menu-btn logout-btn"><a
                                        href="<?php echo wp_logout_url(home_url() . "/"); ?>"><span
                                            class="icon icon-logout"></span><?php _e('Log Out', 'escortwp'); ?></a></li>
                                <li class="subnav-menu-icon" style="position:relative;"><a
                                        href="<?php echo get_site_url(); ?>/messages/"><span
                                            class="icon icon-mail"></span></a>
                                    <div class="notification-div"><?php echo $count_unread; ?></div>
                                </li>
                            <?php } else { ?>
                                <li class="subnav-menu-icon"><a href="#" class="show-popup"><span
                                            class="icon icon-mail"></span></a></li>
                            <?php } ?>
                            ...
                            <li class="subnav-menu-icon"><a
                                    href="<?php echo get_permalink(get_option('search_page_id')); ?>"
                                    title="<?php _e('Search', 'escortwp'); ?>"><span
                                        class="icon icon-search2"></span></a></li>
                            <li class="subnav-menu-icon"><a
                                    href="<?php echo get_permalink(get_option('contact_page_id')); ?>"
                                    title="<?php _e('Contact Us', 'escortwp'); ?>"><span
                                        class="icon icon-mail"></span></a></li>
                        </ul>
                    </div>
                </div>
