    	...
    	<div class="bodybox">
			...
			<div class="r">
				<ul class="pagetitle-menu">
					...
					?>
					<li><a class="pinkbutton rad25" href="<?php echo esc_url( get_permalink(get_option('all_independent_profiles_page_id')) ); ?>"><?php esc_html_e('Independent','escortwp'); ?></a></li>
					<li><a class="pinkbutton rad25" href="<?php echo esc_url( get_permalink(get_option('all_premium_profiles_page_id')) ); ?>"><?php esc_html_e('Premium','escortwp'); ?></a></li>
					<li><a class="pinkbutton rad25" href="<?php echo esc_url( get_permalink(get_option('all_verified_profiles_page_id')) ); ?>"><?php esc_html_e('Verified','escortwp'); ?></a></li>
					<li><a class="pinkbutton rad25" href="<?php echo esc_url( get_permalink(get_option('all_new_profiles_page_id')) ); ?>"><?php esc_html_e('New','escortwp'); ?></a></li>
					<li>
						<a class="pinkbutton online-label rad25" href="<?php echo esc_url( get_permalink(get_option('all_online_profiles_page_id')) ); ?>">
