<?php
/*
Template Name: Classified Ads - Offering
*/
...
get_header(); ?>
	...
	<div class="body">
    	<div class="bodybox">
			<h3 class="l"><?php _e('Classified ads','escortwp'); ?> - <?php _e('offering','escortwp'); ?></h3>
			...
			$args = array(
				...
				'paged' => $paged,
				'meta_query' => array( array('key' => 'type', 'value' => 'offering', 'compare' => '=') )
			);
			query_posts($args);
			if ( have_posts() ) : ?>
